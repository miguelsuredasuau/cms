...
interface KeyComponentsBuilderProps {
  block: BlockConfig;
  onUpdate: (updates: Partial<BlockConfig>) => void;
  availableIds: string[];
}

const KeyComponentsBuilder: React.FC<KeyComponentsBuilderProps> = ({ block, onUpdate, availableIds }) => {
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mb-2">
          Funcionalidad de componentes pendiente de implementar
        </p>
      </div>
    </div>
  );
...
export default KeyComponentsBuilder;